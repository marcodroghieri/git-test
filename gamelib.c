                                                ...
                                                do{ 
                                                    ...
                                                    switch(option){
                                                        case 1: 
                                                            ...
                                                            passa_turno = true;    //dopo ogni volta che avanza il giocatore, il turno passa automaticamente al successivo
                                                            break;
                                                        case 2:
                                                            indietreggia(giocatore_in_turno);
                                                            passa_turno = true;    //dopo ogni volta che indietreggia il giocatore, il turno passa automaticamente al successivo
                                                            break;
                                                        case 3:
...
void stampa_zona(Giocatore* giocatore_in_turno){
 ...
 int apri_porta(Giocatore* giocatore_in_turno){
    time_t h;
    srand((unsigned) time(&h));
    ...
    else if(giocatore_in_turno -> posizione -> zona_successiva -> porta == 1){
